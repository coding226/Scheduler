...
import DemoData from './DemoDataPublic'
...
class Scheduler extends Component {
    ...
    static propTypes = {
        schedulerData: PropTypes.object.isRequired,                 // viewModel, it contains locale settings, resources list and events list
        prevClick: PropTypes.func.isRequired,                       // function to go backward in timeline (set events list of viewModel state)
        nextClick: PropTypes.func.isRequired,                       // function to go backward in timeline (set events list of viewModel state)
        onViewChange: PropTypes.func.isRequired,                    // function to set different view (set events list of viewModel state)
        onSelectDate: PropTypes.func.isRequired,                    // function to select specific date (set events list of viewModel state)
        onSetAddMoreState: PropTypes.func,                          // function ...
        updateEventStart: PropTypes.func,                           // function called when a start of event has been updated (set entire viewModel state)
        updateEventEnd: PropTypes.func,                             // function called when a end of event has been updated (set entire viewModel state)
        moveEvent: PropTypes.func,                                  // function called when an event has been moved to other cell (set entire viewModel state)
        movingEvent: PropTypes.func,                                // function ...
        leftCustomHeader: PropTypes.object,                         // ... it could be a custom header where the timeline navigation is shown        
        rightCustomHeader: PropTypes.object,                        // ... it could be a custom header where you can chose the view mode
        newEvent: PropTypes.func,                                   // function called when a new event has been created (set entire viewModel state)
        subtitleGetter: PropTypes.func,                             // function ...
        eventItemClick: PropTypes.func,                             // function called when an events has been clicked
        viewEventClick: PropTypes.func,                             // function called when standard button 1 of event has been clicked
        viewEventText: PropTypes.string,                            // description of standard button 1 of event
        viewEvent2Click: PropTypes.func,                            // function called when standard button 2 of event has been clicked
        viewEvent2Text: PropTypes.string,                           // description of standard button 2 of event
        conflictOccurred: PropTypes.func,                           // function ...
        eventItemTemplateResolver: PropTypes.func,                  // function ...
        dndSources: PropTypes.array,                                // function ...
        slotClickedFunc: PropTypes.func,                            // function ...
        toggleExpandFunc: PropTypes.func,                           // function called when a group resourse has been expanded or collapsed (set entire viewModel state)
        slotItemTemplateResolver: PropTypes.func,                   // function ...
        nonAgendaCellHeaderTemplateResolver: PropTypes.func,        // function ...
        onScrollLeft: PropTypes.func,                               // function ...
        onScrollRight: PropTypes.func,                              // function ...
        onScrollTop: PropTypes.func,                                // function ...
        onScrollBottom: PropTypes.func,                             // function ...
    }
